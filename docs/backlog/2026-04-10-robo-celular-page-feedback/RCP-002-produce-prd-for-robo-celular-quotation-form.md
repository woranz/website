# RCP-002 - Produce PRD for robo celular quotation form
...
- Entregable estructural: PRD ejecutable con benchmark, campos requeridos, reglas y destino de lead para un formulario o cotizador de robo de celular.
- Visual: si
- Owner visual: Claude
...
La página de `robo-celular` hoy no tiene un formulario o cotizador real. El feedback pide agregarlo, pero antes exige research de mercado y PRD. Eso bloquea cualquier decisión de UI o implementación directa.

## Evidencia

- `data/product-catalog.json:493-498` configura `robo-celular` con `cotizador.modo: contacto`.
...
- Feedback recibido: `Agregar formulario de cotización. Research mercado. Hacer PRD.`

## Riesgo

- Implementar sin benchmark puede dejar afuera datos clave del equipo o del riesgo.
...
- Hacer research de mercado sobre formularios o cotizadores comparables para seguro de celular.
- Definir qué campos son mínimos para una primera captura y cuáles deberían ir en una etapa posterior.
- Producir un PRD específico para `robo-celular`, enlazado a la solución transversal de `TD-015`.
- Definir si el entregable será un quoter real, un lead form enriquecido o una primera etapa híbrida.

## Criterio de aceptacion

- Existe un PRD específico para `robo-celular` con benchmark y alcance aprobado.
