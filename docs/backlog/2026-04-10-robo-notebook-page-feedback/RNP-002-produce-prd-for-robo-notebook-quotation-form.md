# RNP-002 - Produce PRD for robo notebook quotation form
...
- Entregable estructural: PRD ejecutable con benchmark, campos requeridos, reglas y destino de lead para un formulario o cotizador de robo de notebook.
- Visual: si
- Owner visual: Claude
...
La página de `robo-notebook` hoy no tiene un formulario o cotizador real. El feedback pide agregarlo, pero antes exige research de mercado y PRD. Eso bloquea cualquier decisión de UI o implementación directa.

## Evidencia

- `data/product-catalog.json:547-552` configura `robo-notebook` con `cotizador.modo: contacto`.
...
- Feedback recibido: `Agregar cotizador. Hacer research. Requiere PRD.`
...
- Hacer research de mercado sobre formularios o cotizadores comparables para seguro de notebook.
- Definir qué campos son mínimos para una primera captura y cuáles deberían ir en una etapa posterior.
- Producir un PRD específico para `robo-notebook`, enlazado a la solución transversal de `TD-015`.
- Definir si el entregable será un quoter real, un lead form enriquecido o una primera etapa híbrida.

## Criterio de aceptacion

- Existe un PRD específico para `robo-notebook` con benchmark y alcance aprobado.
