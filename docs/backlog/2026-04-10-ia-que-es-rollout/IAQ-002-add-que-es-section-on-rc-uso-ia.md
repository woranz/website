# IAQ-002 - Add que es section on RC uso IA
...
`empresas/responsabilidad-civil-uso-ia` ya cuenta con un documento fuente que define claramente su explicación de producto, pero la página todavía no tiene un bloque `Qué es` registrado en backlog operativo.

## Evidencia

- `docs/source-docs/2026-04-10-ia-productos/Woranz_Productos_IA_Humanos.docx` incluye la descripción fuente de `Responsabilidad Civil por uso de IA`.
- `docs/backlog/2026-04-10-que-es-rollout/QES-001-source-inventory.md` ya inventaría el texto aprobado para `empresas/responsabilidad-civil-uso-ia`.
- `lib/product-page-source.ts:347-353` ya soporta secciones de explicación con título default `Qué es`.

## Riesgo

- Sin este bloque, la página depende solo del hero y de listados operativos para explicar un producto nuevo y potencialmente ambiguo.
...
- Agregar la sección `Qué es` a la página de `responsabilidad-civil-uso-ia`.
...
- `/empresas/coberturas/responsabilidad-civil-uso-ia` muestra una sección `Qué es`.
...
- Verificación estática de la fuente de verdad para `empresas/responsabilidad-civil-uso-ia`.
